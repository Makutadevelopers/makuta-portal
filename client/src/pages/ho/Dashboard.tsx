...
import { useDashboardData, Kpis, SiteRow, VendorOverdue, CategorySpend, MonthTrend } from '../../hooks/useDashboardData';
...
// Lives in components/shared/DueSoonPanel — the MD overview renders the same
// panel, and a local copy meant the two drifted.
