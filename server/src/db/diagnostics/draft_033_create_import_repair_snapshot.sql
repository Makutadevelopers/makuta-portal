-- Create a rollback-insurance snapshot table for the bulk-import data-quality
...
-- migration 031_fix_batch_90209c92_dates.sql, which had no escape hatch).
--
...
CREATE TABLE IF NOT EXISTS payments_repair_snapshot (
  ...
  repair_tag    TEXT NOT NULL,         -- e.g. 'F1_date_fallback' or migration filename
  payment_id    UUID NOT NULL,
  -- mirror of payments columns at snapshot time
  invoice_id    UUID,
  amount        NUMERIC(14,2),
  payment_type  TEXT,
  payment_ref   TEXT,
